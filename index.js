...
const start = () => {
  ...
  bot.on("message", async (msg) => {
    ...
    if (text === "/promotions") {
      return bot.sendMessage(
        chatId,
        "✨Специальные предложения на экраны!\n\n❗При аренде всех экранов в комплексе -15% скидка от общей суммы!🌟\n\n❗При аренде 4-х экранов на проспекте М. Эсамбаева -1000 рублей от общей цены в месяц!💥 \n\n❗❗❗ ☪️ В предверии наступления священного для всех мусульман месяца Рамадан объявляем грандиозные скидки на размещение рекламы. Оформите заказ до 10 марта (включительно) и получите скидку на общую сумму заказа:\nБашня: -50% при аренде 4-х экранов\nАлтайский круг: -50% при аренде трех экранов\nАргун: -50%"
      );
    }
    if (text === "/contacts") {
      return bot.sendMessage(
