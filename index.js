  ...
  bot.on("message", async (msg) => {
    ...
    if (text === "/manual") {
      return bot.sendMessage(
        ...
        2️⃣Размещение видеороликов на LED-экранах "Грозный-Молл" (три стороны) и «Спираль» на Минутке осуществляется в порядке очереди, с установленным временем ожидания от 1,5 до 2 месяцев. Клиент включается в очередь после предоставления готового макета в необходимом формате через Telegram.
        3️⃣Повторные трансляции, оговоренные в Прайсе, осуществляются исключительно без учета трансляций социальных реклам и рекламы Агентства.
        4️⃣В случае возникновения непреодолимых обстоятельств, независящих от ООО «Альфа-Реклама», такими как сбои в подаче электроэнергии и т.д., периоды трансляций видеороликов не подлежат возмещению.
        5️⃣При отказе клиента от услуг, которые уже были оплачены, денежные средства не возвращаются, так как отчет по поступлениям предоставляется учредителю еженедельно.
        6️⃣При оплате по безналичному расчету +10% к общей сумме.
        7️⃣Все предоставляемые услуги оказываются только после ознакомления с данной информацией и их оплаты.
